...
import com.Kmontar31.LandSound.models.Album;
import com.Kmontar31.LandSound.models.Artist;
import com.Kmontar31.LandSound.models.Playlist;
import com.Kmontar31.LandSound.models.Song;
import com.Kmontar31.LandSound.utils.TimberUtils;
import com.Kmontar31.LandSound.R;
import com.Kmontar31.LandSound.dataloaders.AlbumLoader;
import com.Kmontar31.LandSound.dataloaders.AlbumSongLoader;
import com.Kmontar31.LandSound.dataloaders.ArtistAlbumLoader;
import com.Kmontar31.LandSound.dataloaders.ArtistLoader;
import com.Kmontar31.LandSound.dataloaders.ArtistSongLoader;
import com.Kmontar31.LandSound.dataloaders.PlaylistLoader;
import com.Kmontar31.LandSound.dataloaders.PlaylistSongLoader;
import com.Kmontar31.LandSound.dataloaders.SongLoader;
        ...
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconUri(Uri.parse("android.resource://" +
                                "Kmontar31.LandSound/drawable/ic_empty_music2"))
                    ...
                    switch (Integer.parseInt(Character.toString(parentId.charAt(0)))) {
                        case TYPE_ARTIST:
                            ...
                            for (Artist artist : artistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_SONG_ALBUMS) + Long.toString(artist.id), artist.name, Uri.parse("android.resource://" +
                                        "Kmontar31.LandSound/drawable/ic_empty_music2"), TimberUtils.makeCombinedString(mContext, albumNmber, songCount), MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
                        case TYPE_ALBUM:
                        ...
                        case TYPE_ARTIST_SONG_ALBUMS:
                            fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_ALL_SONGS) + Long.parseLong(parentId.substring(1)), "All songs", Uri.parse("android.resource://" +
                                    "Kmontar31.LandSound/drawable/ic_empty_music2"), "All songs by artist", MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            ...
                            for (Playlist playlist : playlistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_PLAYLIST_ALL_SONGS) + Long.toString(playlist.id), playlist.name,
                                        Uri.parse("android.resource://" +
                                                "Kmontar31.LandSound/drawable/ic_empty_music2"), songCount, MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
